...
Abra `public/index.html` em um navegador moderno. A pagina nao depende de build para visualizar.

## Publicacao

Projeto estatico pronto para Vercel. A pasta de saida configurada em `vercel.json` e `public`.
